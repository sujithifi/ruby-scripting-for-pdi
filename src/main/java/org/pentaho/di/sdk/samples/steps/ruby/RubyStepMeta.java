...
@Step(
  id = "RubyStep",
  name = "RubyStep.Name",
  description = "RubyStep.TooltipDesc",
  image = "org/pentaho/di/sdk/samples/steps/ruby/resources/ruby.svg",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform",
  i18nPackageName = "org.pentaho.di.sdk.samples.steps.ruby",
  documentationUrl = "RubyStep.DocumentationURL",
  casesUrl = "RubyStep.CasesURL",
  forumUrl = "RubyStep.ForumURL"
  )
@InjectionSupported( localizationPrefix = "RubyStepMeta.Injection." )
		...
		for (OutputFieldMeta field : outputFields) {
			...
			if (field.isUpdate()){
				...
				if (v.getType() != field.getType()){
					...
					ValueMetaInterface newValueMeta = new ValueMetaBase(field.getName(), field.getType());
				...
				// new field
				ValueMetaInterface v = new ValueMetaBase(field.getName(), field.getType());
				v.setOrigin(origin);
				r.addValueMeta(v);
