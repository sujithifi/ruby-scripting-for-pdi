...
public class TestTransformations extends TestCase {
	...
	public void testRunAllSamples() throws KettleException, InterruptedException{
		...
		System.setProperty("KETTLE_PLUGIN_BASE_FOLDERS", projectDir+"/src/main/plugin"); // the plugin directory is in "testdist"
		
		KettleEnvironment.init();
		
		String jobfile = projectDir+"/src/test/resources/files/tests/run_all_tests.kjb";
